...
SOFTWARE_BASIS_SETS = {
    ...
    "631g**" : "6-31G**",
    "ahlrichs pvdz" : "Ahlrichs pVDZ",
    "ahlrichs tzv" : "Ahlrichs TZV",
    "ahlrichs vdz" : "Ahlrichs VDZ",
    ...
    "augpcs4" : "aug-pcS-4",
    "augpv7z" : "aug-pV7Z",
    "b2 basis set for zn" : "B2 basis set for Zn",
    "bauschlicher ano" : "Bauschlicher ANO",
    "binning/curtiss sv" : "Binning/Curtiss SV",
    "binning/curtiss svp" : "Binning/Curtiss SVP",
    "binning/curtiss vtz" : "Binning/Curtiss VTZ",
    "binning/curtiss vtzp" : "Binning/Curtiss VTZP",
    "ccpcv5z" : "cc-pCV5Z",
    "ccpcv6z" : "cc-pCV6Z",
    ...
    "ccpvtzsegopt" : "cc-pVTZ(seg-opt)",
    "ccpwcv5z" : "cc-pwCV5Z",
    "ccpwcv5z core set" : "cc-pwCV5Z Core Set",
    ...
    "dhfsvp" : "dhf-SV(P)",
    "dhftzvp" : "dhf-TZVP",
    "dunninghay double rydberg" : "Dunning-Hay Double Rydberg",
    "dunninghay rydberg" : "Dunning-Hay Rydberg",
    "dz + double rydberg dunninghay" : "DZ + Double Rydberg (Dunning-Hay)",
    "dz + rydberg (dunning)" : "DZ + Rydberg (Dunning)",
    "dz (dunning)" : "DZ (Dunning)",
    "dzp + rydberg (dunning)" : "DZP + Rydberg (Dunning)",
    "dzp (dunning)" : "DZP (Dunning)",
    "dzq" : "DZQ",
    "dzvp2 (dft orbital)" : "DZVP2 (DFT Orbital)",
    "dzvp (dft orbital)" : "DZVP (DFT Orbital)",
    "feller misc. cvdz" : "Feller Misc. CVDZ",
    "feller misc. cvqz" : "Feller Misc. CVQZ",
    "feller misc. cvtz" : "Feller Misc. CVTZ",
    "gamess pvtz" : "GAMESS PVTZ",
    "gamess vtz" : "GAMESS VTZ",
    "igloii" : "IGLO-II",
    "igloiii" : "IGLO-III",
    "julccpvd+dz" : "jul-cc-pV(D+d)Z",
    "julccpvq+dz" : "jul-cc-pV(Q+d)Z",
    ...
    "mayccpvq+dz" : "may-cc-pV(Q+d)Z",
    "mayccpvt+dz" : "may-cc-pV(T+d)Z",
    "mclean/chandler vtz" : "McLean/Chandler VTZ",
    "mg3s" : "MG3S",
    "midi!" : "MIDI!",
    ...
    "nasa ames ccpcv5z" : "NASA Ames cc-pCV5Z",
    "nasa ames ccpcvqz" : "NASA Ames cc-pCVQZ",
    "nasa ames ccpcvtz" : "NASA Ames cc-pCVTZ",
    "nasa ames ccpv5z" : "NASA Ames cc-pV5Z",
    "nasa ames ccpvqz" : "NASA Ames cc-pVQZ",
    "nasa ames ccpvtz" : "NASA Ames cc-pVTZ",
    "partridge uncontracted 1" : "Partridge Uncontracted 1",
    "partridge uncontracted 2" : "Partridge Uncontracted 2",
    "partridge uncontracted 3" : "Partridge Uncontracted 3",
    "partridge uncontracted 4" : "Partridge Uncontracted 4",
    "pc0" : "pc-0",
    "pc1" : "pc-1",
    "pc2" : "pc-2",
    "pc3" : "pc-3",
    ...
    "roos augmented double zeta ano" : "Roos Augmented Double Zeta ANO",
    "roos augmented triple zeta ano" : "Roos Augmented Triple Zeta ANO",
    "s321g" : "s3-21G",
    "s321g*" : "s3-21G*",
    "s631g" : "s6-31G",
    "s631g*" : "s6-31G*",
    ...
    "sto3g*" : "STO-3G*",
    "sto6g" : "STO-6G",
    "sv + double rydberg dunninghay" : "SV + Double Rydberg (Dunning-Hay)",
    "sv + rydberg dunninghay" : "SV + Rydberg (Dunning-Hay)",
    "sv dunninghay" : "SV (Dunning-Hay)",
    "svp + rydberg dunninghay" : "SVP + Rydberg (Dunning-Hay)",
    "svp dunninghay" : "SVP (Dunning-Hay)",
    "tz (dunning)" : "TZ (Dunning)",
    "tzvp (dft orbital)" : "TZVP (DFT Orbital)",
    "ugbs" : "UGBS",
    "unccemdref" : "un-ccemd-ref",
    "unpcemdref" : "un-pcemd-ref",
    "wachters+f" : "Wachters+f",
